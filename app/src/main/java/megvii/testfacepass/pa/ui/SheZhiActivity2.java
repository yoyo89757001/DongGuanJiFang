...
//    }
    ...
    @OnClick({R.id.rl1, R.id.rl2, R.id.rl3, R.id.rl4, R.id.rl5, R.id.rl6, R.id.rl7,R.id.rl8, R.id.rl9,R.id.rl13,R.id.rl14,R.id.rl15,R.id.rl16,R.id.rl17,R.id.rl28,R.id.daochu,R.id.rl33})
