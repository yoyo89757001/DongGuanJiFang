...
//    OnPaAccessDetectListener onFaceDetectListener = new OnPaAccessDetectListener() {
//
//        @Override
//        public void onFaceDetectFrame(int message, PaAccessDetectFaceResult faceDetectFrame) {
//            super.onFaceDetectFrame(message, faceDetectFrame);
//            //TODO Robin faceDetectFrame 未检测到人脸就为null，所以要做非空判断
//            Log.d("Robin", "message : " + message); //Robin 查看这里的message，对照文档中的状态码来调试
//            if (faceDetectFrame != null) {
////                Log.d("Robin"," faceDetectFrame: " + faceDetectFrame.blurness);
//            }
//        }
//
//        //人脸检测＋特征提取＋活体（如果开启活体）完成
//        @Override
//        public void onFaceDetectResult(int var,PaAccessDetectFaceResult detectResult) {
//            if (detectResult==null)
//                return;
//            int message = detectResult.message;
//            Log.d("Robin", "message : " + message); //Robin 查看这里的message，对照文档中的状态码来调试
//            if (message != PaAccessControlMessage.RESULT_OK) {
//                return;
//            }
//
//            if (isLink){
//                isLink=false;
//              //  float blurness = detectResult.facePassFrame.blurness;
////            Log.d("Robin","blurness blurness: " + blurness);
//                paFacePass.stopFrameDetect();//停止传输nv21数据
//                PaAccessDetectFaceResult facePassFrame = detectResult;
//                Bitmap bitmap = BitmapUtil.getBitmap(facePassFrame.frame, facePassFrame.frameWidth, facePassFrame.frameHeight, facePassFrame.frameOri);
//                bitmap = BitmapUtil.getCropBitmap(bitmap, facePassFrame.rectX, facePassFrame.rectY, facePassFrame.rectW, facePassFrame.rectH);
//
//                shipingAddFaceDialog(bitmap, detectResult.feature);
//               // showDialog();
//            }
//
//        }
...
//    private void showDialog(final Bitmap bitmap, final float[] feature) {
//        if (this.isDestroyed()) {
//            return;
//        }
//        RegisterDialog registerDialog = new RegisterDialog(bitmap);
...
//            @Override
//            public void onReDetectClick() {//重新检测
//                paFacePass.startFrameDetect();
//            }
//        });
//        registerDialog.setOnConfirmClickListener(new RegisterDialog.OnConfirmClickListener() {
//            @Override
//            public void onConfirmClick(String id) {//确认注册,添加人脸到人脸库
//                int result = paFacePass.addFace(id, feature, MyApplication.GROUP_FRAME);//指定group
...
//            return;
//        }
//        paFacePass.offerFrameBuffer(cameraPreviewData.nv21Data, cameraPreviewData.width, cameraPreviewData.height,SettingVar.faceRotation, SettingVar.cameraId);

        //  paFacePass.offerIrFrameBuffer();
