                        ...
                        if (FacePassHandler.isAvailable()) {
                            ...
                            try {
                             ...
                             //   config.livenessModel = FacePassModel.initModel(MyApplication.ampplication.getAssets(), "liveness.3288CPU.rgb.int8.C.bin");
                                ...
                                config.livenessModel = FacePassModel.initModel(MyApplication.myApplication.getAssets(), "liveness.3288GPU.rgb.C.bin");
                                config.livenessGPUCache = FacePassModel.initModel(MyApplication.myApplication.getAssets(), "liveness.GPU.AlgoPolicy.C.cache");
                             ...
                             //   boolean livenessEnabled2 = true;
                                int faceMinThreshold2 = 100;
                                float blurThreshold2 = 0.7f;
                                float lowBrightnessThreshold2 = 68f;
                                float highBrightnessThreshold2 = 212f;
                                float brightnessSTDThreshold2 = 82f;
